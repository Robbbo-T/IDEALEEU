# SUBSYSTEM: 21-40_CABIN_ENVIRONMENT_CONTROL_CONTROLS

**Under System:** 21-AIR-CONDITIONING • **Architecture:** BWB-H2-Hy-E • **Domain:** DDD-DRAINAGE-DEHUMIDIFICATION-DRYING

## Purpose

Controladores HVAC, lógica BMS/ECS, UI. Gestiona los controladores del sistema de aire acondicionado, lógica de gestión ambiental y interfaces de usuario.
...
- `PERFORMANCE/` → control response, algorithm efficiency
