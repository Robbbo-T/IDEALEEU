# SUBSYSTEM: 21-90_SENSORS_ACTUATORS_VALVES

**Under System:** 21-AIR-CONDITIONING • **Architecture:** BWB-H2-Hy-E • **Domain:** DDD-DRAINAGE-DEHUMIDIFICATION-DRYING

## Purpose

Sensórica, actuadores, válvulas de control y solenoides. Gestiona los sensores, actuadores, válvulas de control y solenoides del sistema de aire acondicionado.
...
- `PERFORMANCE/` → response times, accuracy, reliability
