# SUBSYSTEM: 21-60_HUMIDITY_CONTROL_DEHUMIDIFIERS

**Under System:** 21-AIR-CONDITIONING • **Architecture:** BWB-H2-Hy-E • **Domain:** DDD-DRAINAGE-DEHUMIDIFICATION-DRYING

## Purpose

Unidades de deshumidificación (adsorbente / refrigerated). Gestiona los sistemas de control de humedad y deshumidificación, crítico para el dominio DDD (Drainage/Dehumidification/Drying).
...
- `PERFORMANCE/` → dehumidification capacity, energy consumption
