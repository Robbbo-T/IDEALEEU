# Flap Drive Unit - Test Procedures

## Document Control

| Field | Value |
|-------|-------|
| Document ID | ATA-57-LRU_FLAP_DRIVE_UNIT-TEST-001 |
| Revision | 1.0 |
| Date | 2026-01-08 |
| Status | Active |
...
This document defines acceptance and functional test procedures for the Flap Drive Unit.
