# Ice Detection Sensor - Test Procedures

## Document Control

| Field | Value |
|-------|-------|
| Document ID | ATA-57-LRU_ICE_DETECTION-TEST-001 |
| Revision | 1.0 |
| Date | 2026-01-08 |
| Status | Active |
...
This document defines acceptance and functional test procedures for the Ice Detection Sensor.
...
3. Verify integration with ATA-30 Ice/Rain Protection
