# Wing Tip Light - Test Procedures

## Document Control

| Field | Value |
|-------|-------|
| Document ID | ATA-57-LRU_WING_TIP_LIGHT-TEST-001 |
| Revision | 1.0 |
| Date | 2026-01-08 |
| Status | Active |
...
This document defines acceptance and functional test procedures for the Wing Tip Light.
...
3. Verify integration with ATA-33 Lights
