# Aileron Actuator - Test Procedures

## Document Control

| Field | Value |
|-------|-------|
| Document ID | ATA-57-LRU_AILERON_ACTUATOR-TEST-001 |
| Revision | 1.0 |
| Date | 2026-01-08 |
| Status | Active |
...
This document defines acceptance and functional test procedures for the Aileron Actuator.
